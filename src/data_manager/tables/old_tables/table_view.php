...
<body>
    ...
    <body>
        ...
        <h1><?php echo strtoupper($table_name);?></h1>

        <h4><a href=<?php echo "../searches/" . $table_name . "_search.php";?> class="button">Search Table</a></h4>

        <h4><a href=<?php echo "../views/" . $table_name . "_view.php?argument1=create";?> class="button">Create</a></h4>
        ...
        <script>
            ...
            tbody.onclick = function(e) {
                ...
                window.open("../views/" + table_name + "_view.php?argument1=" + data, "_self")
            };
        </script>
    </body>
